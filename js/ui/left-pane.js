...
function setupStyleMapFolder() {
  ...
  if (parameterValues.styleMap.imageLoaded) {
    ...
    styleMapFolder
      ...
      .on("change", (index) => {
        parameterValues.styleMap.f = parameterPresets[index].f;
        parameterValues.styleMap.k = parameterPresets[index].k;

        simulationUniforms.styleMapParameters.value.x =
          parameterPresets[index].f;
        simulationUniforms.styleMapParameters.value.y =
          parameterPresets[index].k;
