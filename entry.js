  ...
  if (!globals.isPaused) {
    ...
    for (let i = 0; i < globals.pingPongSteps; i++) {
      ...
      simulationUniforms.previousIterationTexture.value =
        renderTargets[globals.currentRenderTargetIndex].texture; // grab the result of the last iteration
      ...
      simulationUniforms.previousIterationTexture.value =
        renderTargets[nextRenderTargetIndex].texture; // save the result of this simulation step for use in the next step
      displayUniforms.textureToDisplay.value =
        renderTargets[nextRenderTargetIndex].texture; // pass this result to the display material too
      displayUniforms.previousIterationTexture.value =
        renderTargets[globals.currentRenderTargetIndex].texture; // pass the previous iteration result too for history-based rendering effects
